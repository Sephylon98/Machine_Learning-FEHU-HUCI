...
os.chdir(r'C:\Users\Midox\Documents\Python Scripts\Machine-Learning---FEHU---HUCI\Assignment #2') #remove this for your code
...
def discriminant_fun(covMatrix,feature_vector,u):
    ...
    col_vector = np.dot(ainv_covMatrix,(feature_vector-u)) + np.log(1/2)
